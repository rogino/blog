...
I couldnt get perceptual quantization to work properly, so I can't
...
Quantization error is not an issue, or at least isn't compared to standard 8-bit
SDR formats: one good thing about floating point formats is that accuracy is high
for small values and decreases with magnitude, mirroring the behavior of visual perception.
