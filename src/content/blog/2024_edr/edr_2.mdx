...
tags:
  ...
  - metal
description: >
  Color spaces, transfer functions and everything else you need to know before
  rendering EDR content in Metal
---

import BlogVideoPlayer from "./BlogVideoPlayer.svelte";

In part 1, I covered the various ways of rendering and displaying EDR images in
SwiftUI.
...
<figure>
  ...
  <figcaption>Visualization by [Myndex](https://commons.wikimedia.org/wiki/User:Myndex), [CC BY-SA 4.0 DEED](https://creativecommons.org/licenses/by-sa/4.0/deed.en)</figcaption>
</figure>
...
![Comparison between linear and gamma](@assets/blog/2024/edr/linear_gamma_comparison_linear_scale.png)
...
iPhone 15 Pro goes up to 2,000 nits. The transfer function maps directly to
output luminance and requires additional metadata if you want it to be properly
tone-mapped.
...
_Headroom_ is the multiple beyond SDR white that the display can output
a value of `2` means that, under optimum conditions, the content can be
...
[Composure Camera](https://composure.rioogino.com) for free,
increase your screen brightness to the max, and when you see the EDR badge,
think, 'damn, he spent all this time on _this_?'
